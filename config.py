...
INSTAGRAM_ACCESS_TOKEN = os.getenv("INSTAGRAM_ACCESS_TOKEN") or os.getenv("INSTAGRAM_AI_BY_CHU_ACCESS_TOKEN")
INSTAGRAM_USER_ID = os.getenv("INSTAGRAM_USER_ID") or os.getenv("INSTAGRAM_AI_BY_CHU_USER_ID")
INSTAGRAM_API_BASE = os.getenv("INSTAGRAM_API_BASE", "https://graph.instagram.com/v22.0")
INSTAGRAM_MEDIA_PROXY_BASE_URL = os.getenv("INSTAGRAM_MEDIA_PROXY_BASE_URL") or os.getenv("THREADS_MEDIA_PROXY_BASE_URL")
INSTAGRAM_MEDIA_PROXY_SECRET = os.getenv("INSTAGRAM_MEDIA_PROXY_SECRET") or os.getenv("THREADS_MEDIA_PROXY_SECRET")
INSTAGRAM_MEDIA_PROXY_TTL_SECONDS = int(os.getenv("INSTAGRAM_MEDIA_PROXY_TTL_SECONDS", os.getenv("THREADS_MEDIA_PROXY_TTL_SECONDS", "300")))
INSTAGRAM_MEDIA_PROXY_BOT_ALIAS = os.getenv("INSTAGRAM_MEDIA_PROXY_BOT_ALIAS", os.getenv("THREADS_MEDIA_PROXY_BOT_ALIAS", ""))
